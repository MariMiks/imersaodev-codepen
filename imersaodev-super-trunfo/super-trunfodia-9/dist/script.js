...
exibirQuantidadePontos()
exibirQuantidadeCartas()

function exibirQuantidadePontos(){
  var divPlacar = document.getElementById ('placar')
  var html = "Você " + pontosJogador + " / " + "Computador " + pontosMaquina
...
function exibeCartaJogador() {
    ...
    var moldura = '<img src="https://i.imgur.com/KMfw2JF.png" style=" width: inherit; height: inherit; position: absolute;">';
...
function jogar() {
  ...
  if (cartas.length == 0){
    ...
    if (pontosJogador > pontosMaquina){
      ...
      htmlResultado = "<p class = 'resultado-final'>Você perdeu para o computador</p>"
    } else {
      htmlResultado = "<p class = 'resultado-final'>Empatou com o computador</p>"
    }
  } else {
...
function proximaRodada() {
  ...
  divCartas.innerHTML = '<div id="carta-jogador" class="cartas"><img src="https://i.imgur.com/WKfV8Ni.png" style=" width: inherit; height: inherit; position: absolute;"></div> <div id= "carta-maquina" class="cartas"><img src="https://i.imgur.com/WKfV8Ni.png" style=" width: inherit; height: inherit; position: absolute;"></div>'
